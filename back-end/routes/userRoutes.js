...
import { registerClient, registerProfessional, loginUser, getProfessionalProfile, updateProfessionalProfile, getClientProfile, updateClientProfile, getAllProfessionals, searchUsers, changePassword } from '../controllers/userController.js';
import { uploadProfessional, uploadClientProfile, uploadProfessionalProfile } from '../middleware/uploadMiddleware.js';
