...
export const UserProvider = ({ children }) => {
  ...
  const [token, setToken] = useState(Cookies.get('token') || null); // Initialize with token from Cookies
      ...
      const fetchUserProfile = async () => {
        ...
        try {
          ...
          try {
            ...
            console.error('Error fetching client profile:', clientError.response ? clientError.response.data : clientError.message);
  ...
  return (
    <UserContext.Provider value={{ user, role, isAuthenticated, setUser, setRole, setIsAuthenticated, loading, setLoading, setToken }}>
      {children}
